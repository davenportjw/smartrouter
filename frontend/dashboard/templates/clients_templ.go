...
func ClientModal(client *config.Client) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 24, "</p></div><!-- Creation Form --><form hx-post=\"/admin/clients/create\" class=\"mt-6 space-y-4\"><div id=\"error-alert-container\"></div><div class=\"grid grid-cols-2 gap-4\"><div><label for=\"client_id\" class=\"block text-xs font-medium text-gray-700\">Client ID (Slug)</label> ")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if client != nil {
